...
ch1 = 10; % ID of first chain
ch2 = 12; % ID of second chain
...
set(H,'LineStyle','none','Marker','o','MarkerEdgeColor','k','MarkerFaceColor',color(2,:),'MarkerSize',5)
hold on
J = plot3(chains_per(:,1), chains_per(:,2), chains_per(:,3));
set(J,'LineStyle','none','Marker','o','MarkerEdgeColor','k','MarkerFaceColor',color(7,:),'MarkerSize',5)
hold off
